...
public partial class VisitMapper
{
    ...
    /// <summary>Publiczne metody z uzupełnianiem PatientFullName, który nie może być zmapowany przez Mapperly.</summary>
    ...
    /// <summary>Kolekcja Visit -> lista VisitListItemDto.</summary>
